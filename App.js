...
const msgEnd = useRef(null);
  ...
  const[messages, setMesssages ] = useState([
      {
      text: "Hi I am CatGPT , a state-of-the-art language model developed by Abhishek",
      isBot: true,
  }
]);
    ...
    <div className="App">
        ...
        <div className="main">
            ...
            <div className="chatFooter">
                ...
                <p>Chat GPT may produce incorrect results about people , places , or facts etc. Version August'24 </p>
            </div>
        </div> 
    </div>
  );
